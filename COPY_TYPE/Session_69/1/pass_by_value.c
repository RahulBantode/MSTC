...
Address of local variable (m) = 12580852
Address of local variable (n) : 12580856
Before call to test_function():
m=10 , n=20
Inside test_function
Address of formal parameter (x) = 12580844
Address of formal parameter (y) = 12580848
BEFORE ASSIGNING TO x,y | x=10,y=20
AFTER ASSIGNING TO x,y | x=10000,y=20000
Returning to main
